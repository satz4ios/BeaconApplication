...
-(void)showInView:(UIView *)view{
    ...
    for (NSString *buttonTitle in buttonTitles) {
        ...
        [button.titleLabel setFont:[UIFont fontWithName:@"Raleway-Medium" size:18]];
...
//            subtitle.font = [UIFont systemFontOfSize:_subtitleFontSize];
            subtitle.font = [UIFont fontWithName:@"Raleway" size:_subtitleFontSize];
...
//            mainTitle.font = [UIFont systemFontOfSize:_titleFontSize];
            mainTitle.font = [UIFont fontWithName:@"Raleway-Medium" size:_titleFontSize];
